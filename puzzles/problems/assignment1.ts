...
const myArr = [1, 2, 113, 8, 42, 111, 10, 3, 523, 6, 226, 7, 7, 7, 227, 87, 7, 7, 7, 743, 7, 7, 34, 34, 43, 3, 343, 3, 333, 3, 323, 3, 3, 3, 5, 6, 7, 8, 1, 3, 435]
function isLargestNumberEven(arr: number[]): boolean {
  ...
  let remainder = biggestNumberSeenSoFar % 2
...
const myCatsArr = [{ name: "oreo", pelt: "tuxedo", eyes: "green" }, { name: "tiger", pelt: "orange", eyes: 'blue' }]
